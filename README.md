...
The goal is to build a machine learning pipeline that can identify fraudulent activities (mainly in TRANSFER and CASH_OUT transactions) while balancing detection performance and false alarms.
